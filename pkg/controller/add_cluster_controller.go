...
//+kubebuilder:rbac:groups=libvirt.k8s.io,resources=libvirtclusterproviderspecs;libvirtclusterproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
